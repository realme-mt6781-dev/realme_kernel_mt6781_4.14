...
struct CAMERA_DEVICE_INFO gImgEepromInfo_blade = {
    .i4SensorNum = 3,
    .pCamModuleInfo = {
        {HI1336_SENSOR_ID_BLADE,  0xA0, {0x00, 0x06}, 0xB0, 1, {0x92,0xFF,0xFF,0x94}, "Cam_r0", "hi1336"},
        {HI556_SENSOR_ID_BLADE,  0x40, {0x00, 0x06}, 0x0C35, 0, {0x34,0x36,0x36,0x36}, "Cam_f",  "hi556"},
...
struct CAMERA_DEVICE_INFO gImgEepromInfo_bladeA = {
    ...
    .pCamModuleInfo = {
        ...
        {SC800CS_SENSOR_ID_BLADE,  0xA0, {0x00, 0x06}, 0x834, 0, {0x92,0x96,0x94,0x94}, "Cam_f",  "sc800cs"},
        {SC201CS1_SENSOR_ID_BLADE,  0xA4, {0x00, 0x06}, 0x834, 0, {0x34,0x36,0x36,0x36}, "Cam_r1", "sc201cs1"},
        {BF20A1_SENSOR_ID_BLADE,     0xFF, {0xFF, 0xFF}, 0xFF, 0, {0xFF,0xFF,0xFF,0xFF}, "Cam_r2", "bf20a1"},
    },
    .i4MWDataIdx = 0xFF,
    .i4MTDataIdx = 0xFF,
    .i4FrontDataIdx = 0xFF,
...
void oplus_imgsensor_hwcfg()
{
    if (is_project(20181) || is_project(20355)) {
        ...
        || is_project(0x2260A) || is_project(22609) || is_project(22669) || is_project(0x2260B) || is_project(0x2266A)) {
         ...
         } else if(is_project(22669) || is_project(0x2260B) || is_project(0x2266A)) {
